...
CREATE TABLE order_items (
    ...
    CONSTRAINT ck_order_items_price CHECK (price_per_unit >= 0)
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
...
VALUES (
        ...
        '/images/categories/frutas-verduras.jpg'
    ),
    (
        'Carnes',
        'Carnes frescas y embutidos',
        '/images/categories/carnes.jpg'
    ),
    (
        'Lácteos',
        'Leche, quesos y derivados',
        '/images/categories/lacteos.jpg'
    ),
    (
        'Panadería',
        'Pan fresco y productos de panadería',
        '/images/categories/panaderia.jpg'
    ),
    (
        'Despensa',
        'Productos básicos y conservas',
        '/images/categories/despensa.jpg'
    );
...
VALUES (
        'Manzanas Rojas',
        'Manzanas rojas frescas, ideales para consumo directo',
        2.50,
        'MANZ-001',
        100,
        '/images/products/manzanas-rojas.jpg',
        1
    ),
    (
        'Pechuga de Pollo',
        'Pechuga de pollo fresca, sin piel',
        8.90,
        'POLL-001',
        50,
        '/images/products/pechuga-pollo.jpg',
        2
    ),
    (
        'Leche Entera',
        'Leche entera pasteurizada 1L',
        1.20,
        'LECH-001',
        200,
        '/images/products/leche-entera.jpg',
        3
    ),
    (
        'Pan Integral',
        'Pan integral artesanal 500g',
        2.80,
        'PAN-001',
        30,
        '/images/products/pan-integral.jpg',
        4
    ),
    (
        'Arroz Blanco',
        'Arroz blanco grano largo 1kg',
        1.50,
        'ARRO-001',
        80,
        '/images/products/arroz-blanco.jpg',
        5
    );
...
VALUES (
        ...
        '$2b$10$rQZ9yP2J5X7vK8wL3mN4O.vH6tR9sA2dF5gH8jK1lM3nP6qS9tU2v',
        'Calle Principal 123',
        'Ciudad',
        '12345',
        '+1234567890'
...
DROP VIEW IF EXISTS v_products_with_category;
...
DROP PROCEDURE IF EXISTS sp_get_cart_total;
